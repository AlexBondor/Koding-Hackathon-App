					...
					<div class="container">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators">
								<li data-target="#carousel-example-generic" data-slide-to="0" class="active" disabled><img src="images/avatar-1.png" width="64" height="64" alt="" class="img-circle"></li>
								...
								<li class = "cursorrr" data-target="#carousel-example-generic" data-slide-to="2"><img src="images/avatar-3.png" width="64" height="64" alt="salut" class="img-circle"></li>
							</ol>
						</div>
					</div>
				</section>
