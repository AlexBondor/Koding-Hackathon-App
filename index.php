        ...
        <nav id="navbar" class="site-navbar navbar navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <h1 class="navbar-brand"><i class="fa fa-power-off"></i> <a href="index.html">Start</a></h1>
            </div>
        ...
        <section class="section section-center section-cta">
          <div class="container">
            ...
            <div class="main-action row">
              <div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2"><a href="#" class="smooth-scroll btn btn-lg btn-block btn-danger">Request Quote</a></div>
              <div class="col-md-3 col-sm-4"><a href="#" class="smooth-scroll btn btn-lg btn-block btn-default">View Portfolio</a></div>
            </div>
          </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage4.s3.amazonaws.com/78f166dc77a011e3a3ef0e7d4056843c_6.jpg">
                        <h5>Rihanna</h5>
                    </div>
                    
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage5.s3.amazonaws.com/7cd1ed40766411e3b2c112112ffff7c9_6.jpg">
                        <h5>Marry</h5>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage8.s3.amazonaws.com/f43436ca180b11e39a4922000a1fb37b_6.jpg">
                        <h5>Ronaldo</h5>
                    </div>
                    
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage11.s3.amazonaws.com/532c6464798b11e3855a126610d3d793_6.jpg">
                        <h5>Jackie Lord</h5>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage0.s3.amazonaws.com/4ed0bf8a742e11e3bb680ee50d64ca74_6.jpg">
                        <h5>David Beckham</h5>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <img src="http://distilleryimage0.s3.amazonaws.com/b8adbd6677f511e3b8cd1227d7fa1b14_6.jpg">
                        <h5>John Doe</h5>
                    </div>
                </div>
            </div>
          ...
          <div id="sidebar-footer-2">
            <div class="row">
              ...
              <aside class="widget widget_flickr col-sm-6">
                ...
                <a href="#" class="hover-effect"><img src="images/photo-2.jpg" /><span class="overlay"><i class="fa fa-plus"></i></span></a>
                <a href="#" class="hover-effect"><img src="images/photo-3.jpg" /><span class="overlay"><i class="fa fa-plus"></i></span></a>
                <a href="#" class="hover-effect"><img src="images/photo-1.jpg" /><span class="overlay"><i class="fa fa-plus"></i></span></a>
              </aside>

            </div>
          </div>

          <div class="copyright"><p>© 2014 Company, Inc.<br /> Theme: Start 1.2.1. Designed by YoArts</p></div>
        </div>
      </footer>
    </div>
