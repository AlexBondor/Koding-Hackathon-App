    ...
    <div id="page">
      ...
      <main id="main" class="site-main">
        ...
        <section class="section section-center section-cta">
          <div class="container">
            ...
            Located in the Someșul Mic River valley, the city is considered the unofficial capital to the historical province of Transylvania.</p>
        ...
        <!--<section id="team" class="section section-center section-hilite section-team">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3"><iframe width="768" height="320" src="http://www.flowlab.io/game/embed/117410" frameborder="0" allowfullscreen></iframe></div>
                </div>
            </div>
        </section>-->
      ...
      <footer id="footer" class="site-footer">
        <div class="container">
          ...
          <div class="copyright"><p>© 2014 Team 3 Corporation</p></div>
        </div>
      </footer>
    </div>
